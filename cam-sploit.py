...
print("""
  Please Wait Checking For Connection...
  """)
...
print("""
\033[1;31m\033[1;37m   ____                ____        _       _ _    
  / ___|__ _ _ __ ___ / ___| _ __ | | ___ (_) |_ 
 | |   / _` | '_ ` _ \\\___ \| '_ \| |/ _ \| | __|
 | |__| (_| | | | | | |___) | |_) | | (_) | | |_ 
  \____\__,_|_| |_| |_|____/| .__/|_|\___/|_|\__|
                            |_|      white_hacker.official

# CamSploit.
# Version     : 1.0
# Description : this tool gives you the online cameras ip && port no. in some cases it might have password procted you can use camover tool to crack the password...
